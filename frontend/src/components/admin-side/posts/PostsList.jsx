  ...
  return (
    <div className='p-5 bg-gray-200'>
      <div className='flex justify-between my-5'>
        <div>
          <button onClick={handleAllPosts} className='font-bold'>All Posts</button>
            ...
            <div key={post.id} className="p-4 border rounded-md shadow-md bg-gray-100 mb-4">
              ...
              <div className="mt-2">
                ...
                <button 
                  ...
                  className="mt-2 bg-red-600 text-white p-2 rounded-md cursor-pointer"
                >
                  Remove
                </button>
                <Link 
                  to={`/dashboard/posts/${post.id}/edit`} 
                  className="mt-2 bg-blue-600 text-white p-2 rounded-md cursor-pointer ml-5"
                >
                  Edit
                </Link>
              </div>
